...
The initial strict brush-pixel comparison found a Rough Pen rasterization difference of two channels at1/255 intensity after integer translation. The other nine brush families were exact. The final test requires identical production geometry and limits rasterization differences to at most four channels, each at most1/255. It preserves the original failure and measured diagnostic rather than claiming exact pixel parity.
