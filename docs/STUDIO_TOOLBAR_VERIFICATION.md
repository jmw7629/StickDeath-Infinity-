...
Thirteen production layout groups pass locally, including 1,440 bounded placement/drag samples, popup clearance and noncollapsed canvas checks. All 107 app declarations and the three changed SwiftUI bodies pass an arm64 iOS 17 typecheck against SDK 26.2. The obsolete right-dock source and its explicit Xcode membership are removed. These checks do not prove a linked app or simulator pass.
