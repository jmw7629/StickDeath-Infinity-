  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 relative min-h-screen bg-[#0a0a0f]">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-red-600/5 blur-[120px]" />
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-red-600/3 blur-[120px]" />
      </div>
