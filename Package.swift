...
//
// NOTE: The full StickDeathInfinity target requires SwiftUI (iOS only).
// For Linux CI, run `swift build --skip-update` to verify dependency
// resolution. Full compilation and tests require Xcode on macOS.
