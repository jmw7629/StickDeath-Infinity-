...
// initialised with a dummy origin so the app compiles and launches.
// All Supabase calls will fail gracefully with network errors,
// which the existing services already handle via try? / catch.
// ═══════════════════════════════════════════════════════════════════
