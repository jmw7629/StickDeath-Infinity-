                                ...
                                ForEach(skillLevels, id: \.self) { level in
                                    Button {
                                        ...
                                        Text(level.capitalized)
                                            ...
                                            .background(skillLevel == level ? .red : ThemeManager.surface)
                                            .clipShape(Capsule())
                                    }
                                }
                            }
                                ...
                                ForEach(allInterests, id: \.self) { interest in
                                    Button {
                                        ...
                                        Text(interest)
                                            ...
                                            .background(selectedInterests.contains(interest) ? .red : ThemeManager.surface)
                                            .clipShape(Capsule())
                                    }
                                }
                            }
                                ...
                                ForEach(fpsOptions, id: \.self) { fps in
                                    Button {
                                        ...
                                        Text("\(fps) fps")
                                            ...
                                            .padding(.horizontal, 14).padding(.vertical, 8)
                                            .background(preferredFPS == fps ? .red : ThemeManager.surface)
                                            .clipShape(Capsule())
                                    }
                                }
                            }
                            ...
                            HStack(spacing: 12) {
                                ForEach(canvasOptions, id: \.0) { option in
                                    Button {
                                        ...
                                        .foregroundStyle(canvasPreference == option.0 ? .red : .gray)
                                        .frame(width: 70, height: 60)
                                        .background(canvasPreference == option.0 ? .red.opacity(0.15) : ThemeManager.surface)
                                        .clipShape(RoundedRectangle(cornerRadius: 10))
                                    }
                                }
                            }
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ThemeManager.background.ignoresSafeArea()
                VStack(spacing: 24) {
                    Image(systemName: "star.fill").font(.system(size: 56)).foregroundStyle(.red)
                    ...
                    Text("$4.99 / month").font(.title2.bold()).foregroundStyle(.red)
